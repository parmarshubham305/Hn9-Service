        ...
        <div className="container">
            <div className="row align-items-center justify-content-between">
                <div className="col-md-6">
                    <img className='img-fluid' loading='lazy' width="" height="" src={SuccessImage} alt="banner image" />
                </div>
                <div className="col-md-6">
                    <h2 className='fw-semibold text-primary heading-center'>Empowering Dreams, Building Success: The HN9 Way.</h2>
